label(1).focus = { 'U3','U4','U5','U6','U7','U8','U9'};
label(2).focus = {'O1','O2','O3','O4','O5','O6','O7','O8','O9','O10','I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','Y1','Y2'};
label(3).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','T2','T3','T4','T5','T6','T7','T8','T9','T10'};
label(4).focus = {'R2','R3','R4','R5','R6','R7','Q2','Q3','Q4','Q5','Q6','Q7'};
label(5).focus = {'W9','N9','M9','L6','Q11'};
label(6).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','B1','B2','C1','C2'};
label(7).focus = {'M1','M2','M3','M4','M5','M6','M7','M8','M9','M10','N1','N2','N3','N4','N5','N6','N7','N8','N9','N10'};
label(8).focus = {'B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','O1','O2','O3','O4','O5','O6','O7','O8','O9','O10','V1','V2','V3','V4','V5','V6','V7','V8','V9','V10','P1','P2','P3','P4','P5','P6','P7','P8','P9','P10','U1','U2','U3','U4','U5','U6','U7','U8','U9','U10','F1','F2','F3','F4','F5','F6','F7','F8','F9','F10'};
label(9).focus = {'Q1','Q2','Q3','Q4','Q5','Q6','Q7','Q8','Q9','Q10','R1','R2','R3','R4','R5','R6','R7','R8','R9','R10','T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','X1','X2'};
label(10).focus = {'M1','M2','M3','M4','M5','M6','M7','M8','M9','M10','N1','N2','N3','N4','N5','N6','N7','N8','N9','N10'};
label(11).focus = {'X1','X2','Y1','Y2'};
label(12).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','B1','B2','C1','C2','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10'};
label(13).focus = {'B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','W1','W2','W3','W4','W5','W6','W7','W8','W9','W10'};
label(14).focus = { 'Q1','Q2','Q4','Q5','Q6','Q7','Q8'};
label(15).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','B4','B5','B6','B7','B8','B9','B10','T4','T5','T6','T7','T8','T9','T10'};
label(16).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','C1','C2'};
label(17).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','T3','T4','T5','T6','T7','T8','T9','T10','B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','C1','C2','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10'};
label(18).focus = {'Y1','Y2'};
label(19).focus = {'Z6','Z7'};
label(20).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','C1','C2','C3','C4','C5','C6','C7','C8','C9','C10'};
label(21).focus = {'O1','O2','O3','O4','O5','O6','O7','O8','O9','O10','F1','F2','F3','F4','F5','F6','F7','F8','F9','F10','X1','X2','X3','X4','X5','X6','X7','X8','X9','X10'};
label(22).focus = {'M1','M2','M3','M4','M5','M6','M7','M8','M9','M10','N1','N2','N3','N4','N5','N6','N7','N8','N9','N10','F1','F2','F3','F4','F5','F6','F7','F8','F9','F10','O1','O2','O3','O4','O5','O6','O7','O8','O9','O10'};
label(23).focus = {'N1','N2','N3','N4','N5','N6','N7','N8','N9','N10'};
label(24).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','T3','T4','T5','T6','T7','T8','T9','T10','C1','C2','F1','F2','F3','F4','F5','F6','F7','F8','F9','F10'};
label(25).focus = {'Y1','Y2'};
label(26).focus = {'S3','S4','S5','S6','S7','S8','S9','S10'};
label(27).focus = {'V1','V2','V3','V4','V5','V6','V7','V8','V9','V10','O1','O2','O3','O4','O5','O6','O7','O8','O9','O10','P1','P2','P3','P4','P5','P6','P7','P8','P9','P10','X1','X2','X3','X4','X5','X6','X7','X8','X9','X10','W1','W2','W3','W4','W5','W6','W7','W8','W9','W10','S1','S2','S3','S4','S5','S6','S7','S8','S9','S10','U1','U2','U3','U4','U5','U6','U7','U8','C1','C2','C3','C4','C5','C6','C7','C8','F1','F2','F3','F4','F5','F6','F7','F8','M1','M2','M3','M4','M5','M6','M7','M8','N1','N2','N3','N4','N5','N6','N7','N8'};
label(28).focus = {'O1','O2','O3','O4','O5','O6','O7','O8','O9','O10','V1','V2','V3','V4','V5','V6','V7','V8','V9','V10','P1','P2','P3','P4','P5','P6','P7','P8','P9','P10'};
label(29).focus = {'C1','C2','C3','C4','C5','C6','C7','C8','C9','C10'};
label(30).focus = {'I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','C1','C2','C3','C4','C5','C6','C7','C8','C9','C10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10'};
label(31).focus = {'T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','U1','U2','U3','U4','U5','U6','U7','U8','U9','U10','I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','B1','B2','B3','B4','B5','B6','B7','B8','B9','B10','C1','C2','C3','C4','C5','C6','C7','C8','C9','C10','F1','F2','F3','F4','F5','F6','F7','F8','F9','F10','E1','E2','E3','E4','E5','E6','E7','E8','E9','E10'};
...
isequal(label(3).focus,labels(3).focus)
